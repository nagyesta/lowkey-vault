...
public interface ApiVersionAware {
    ...
    SortedSet<String> V7_3_AND_LATER = Collections.unmodifiableSortedSet(
            new TreeSet<>(Set.of(ApiConstants.V_7_3, ApiConstants.V_7_4, ApiConstants.V_7_5)));
    /**
    ...
    SortedSet<String> ALL_VERSIONS = Collections.unmodifiableSortedSet(
            new TreeSet<>(Set.of(ApiConstants.V_7_2, ApiConstants.V_7_3, ApiConstants.V_7_4, ApiConstants.V_7_5)));
