...
import static com.github.nagyesta.lowkeyvault.model.common.ApiConstants.API_VERSION_7_6;
...
@RestController
@Validated
@Component("keyCryptoControllerV76")
@SuppressWarnings("java:S110")
public class KeyCryptoController
        extends CommonKeyCryptoController {

    public KeyCryptoController(
