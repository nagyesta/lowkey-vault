...
public class SecretConverterRegistry
        extends BaseEntityConverterRegistry<SecretEntityId, VersionedSecretEntityId, ReadOnlyKeyVaultSecretEntity,
        KeyVaultSecretModel, DeletedKeyVaultSecretModel, SecretPropertiesModel, KeyVaultSecretItemModel,
        DeletedKeyVaultSecretItemModel, SecretBackupListItem> {

    @Override
    public SecretEntityId entityId(
            final URI baseUri,
            final String name) {
    ...
    @Override
    public VersionedSecretEntityId versionedEntityId(
            final URI baseUri,
            final String name,
