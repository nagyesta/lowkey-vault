...
public class CertificateEntityToV73BackupConverter {
    ...
    public CertificateBackupListItem convert(final ReadOnlyKeyVaultCertificateEntity source) {
        ...
        listItem.setPolicy(policyModelConverter.convert(source, vaultUri));
        listItem.setIssuancePolicy(issuancePolicyModelConverter.convert(source, vaultUri));
        ...
        listItem.setAttributes(propertiesModelConverter.convert(source));
    ...
    private List<CertificateLifetimeActionModel> fetchLifetimeActionModels(
        ...
        return lifetimeActionsConverter.convert(lifetimeActionPolicy);
    }
}
