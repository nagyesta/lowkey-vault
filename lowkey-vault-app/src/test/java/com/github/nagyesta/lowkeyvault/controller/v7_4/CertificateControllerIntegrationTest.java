...
class CertificateControllerIntegrationTest extends BaseCertificateControllerIntegrationTest {
    ...
    @Autowired
    @Qualifier("CertificateControllerV74")
    ...
    public static Stream<Arguments> certificateListProvider() {
        ...
        return Stream.<Arguments>builder()
                .add(Arguments.of(uri1, 5, 0,
                        uri1 + "/certificates?api-version=7.4&$skiptoken=5&maxresults=5&includePending=true"))
                .add(Arguments.of(uri2, 3, 1,
                        uri2 + "/certificates?api-version=7.4&$skiptoken=4&maxresults=3&includePending=true"))
    ...
    @Test
    void testApiVersionShouldReturnV74WhenCalled() {
        //given
        ...
        //then
        Assertions.assertEquals(V_7_4, actual);
    }
