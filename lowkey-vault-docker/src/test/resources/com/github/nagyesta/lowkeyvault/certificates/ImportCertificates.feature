Feature: Certificate import
    ...
    Scenario Outline: RSA_CERT_UPDATE_01 Imported RSA certificates can be updated with the certificate client
        ...
        Examples:
            ...
            | 7.6        | 76-updateRsaCert2048Pkcs         | rsa-localhost.p12   | changeit | PKCS12 | PKCS12      | CN=localhost   | CN=updated.local |
            | 2025-07-01 | 2025-07-01-updateRsaCert2048Pkcs | rsa-localhost.p12   | changeit | PKCS12 | PKCS12      | CN=localhost   | CN=updated.local |
    ...
    Scenario Outline: EC_CERT_UPDATE_01 Imported EC certificates can be updated with the certificate client
        ...
        Examples:
            ...
            | 7.6        | 76-updateEc521Pkcs         | ec521-ec-localhost.p12 | changeit | PKCS12 | PEM         | CN=ec.localhost | CN=ec.localhost  |
            | 2025-07-01 | 2025-07-01-updateEc521Pkcs | ec521-ec-localhost.p12 | changeit | PKCS12 | PEM         | CN=ec.localhost | CN=ec.localhost  |
