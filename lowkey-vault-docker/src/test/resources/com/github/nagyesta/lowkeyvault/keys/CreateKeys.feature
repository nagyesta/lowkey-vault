Feature: Key creation
  ...
  Scenario Outline: EC_CREATE_01 Single versions of EC keys can be created with the key client
    ...
    Examples:
      ...
      | 7.2 | without | 72-createEcKeyAllOps     | P-256     | 32     | enabled       | encrypt,decrypt,wrapKey,unwrapKey,sign,verify,import | null    | null      | null              |
      | 7.2 | without | 72-createEcKeyOperations | P-256     | 32     | enabled       | wrapKey,unwrapKey                                    | null    | null      | null              |
      ...
      | 7.3 | without | 73-createEcKeyAllOps     | P-256     | 32     | enabled       | encrypt,decrypt,wrapKey,unwrapKey,sign,verify,import | null    | null      | null              |
      | 7.3 | without | 73-createEcKeyOperations | P-256     | 32     | enabled       | wrapKey,unwrapKey                                    | null    | null      | null              |
  ...
  Scenario Outline: OCT_CREATE_01 Single versions of OCT keys can be created with the key client
    ...
    Examples:
      ...
      | 7.2 | with | 72-createOctKeyAllOps     | 128     | enabled       | encrypt,decrypt,wrapKey,unwrapKey,sign,verify,import | null    | null      | null              |
      ...
      | 7.3 | with | 73-createOctKeyAllOps     | 128     | enabled       | encrypt,decrypt,wrapKey,unwrapKey,sign,verify,import | null    | null      | null              |
