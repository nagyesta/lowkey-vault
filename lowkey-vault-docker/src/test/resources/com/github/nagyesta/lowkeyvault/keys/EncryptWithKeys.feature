Feature: Key encrypt and decrypt
    ...
    Scenario Outline: RSA_ENCRYPT_01 An RSA key is created with the key client then used for encrypt and decrypt operations
        ...
        Examples:
            ...
            | 7.6        | encryptRsaKey-10 | 2048    | RSA-OAEP-256 | <?xml version="1.0"?><none/>                 |
            | 2025-07-01 | encryptRsaKey-11 | 2048    | RSA-OAEP-256 | <?xml version="1.0"?><none/>                 |
    ...
    Scenario Outline: OCT_ENCRYPT_01 An OCT key is created with the key client then used for encrypt and decrypt operations
        ...
        Examples:
            ...
            | 7.6        | encryptOct-10 | 128     | A128CBC    | Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do. |
            | 2025-07-01 | encryptOct-11 | 128     | A128CBC    | Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do. |
