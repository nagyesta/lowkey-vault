Feature: Key list
  ...
  @Key @KeyCreate @KeyList @RSA
  Scenario Outline: RSA_LIST_01 RSA keys are created with the key client then all are listed
    Given a key client is created with the vault named keys-list-rsa-<count>
  ...
  @Key @KeyCreate @KeyList @EC
  Scenario Outline: EC_LIST_01 EC keys are created with the key client then all are listed
    Given a key client is created with the vault named keys-list-ec-<count>
  ...
  @Key @KeyCreate @KeyList @OCT
  Scenario Outline: OCT_LIST_01 OCT keys are created with the key client then all are listed
    Given a key client is created with the vault named keys-list-oct-<count>
